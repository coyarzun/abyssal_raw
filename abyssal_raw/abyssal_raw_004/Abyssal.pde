class Abyssal {
  ...
  void wlight(float v){  abysses[cAbyss].wlight = int (map(v,0,1.0,0,2)) ;      abysses[cAbyss].wlight%=3;    }
  void wichView(float v){  abysses[cAbyss].wichView= int (map(v,0,1.0,0,5)) ;    abysses[cAbyss].wichView%=5;  }
